...
flowchart LR
  ...
  plugin_dsh_base_credentials_oauth["credentials-oauth<br/>@deepseek-ai/dsh-credentials-oauth"]
  cfg --> plugin_dsh_base_credentials_oauth
...
| `credentials-oauth` | `@deepseek-ai/dsh-credentials-oauth` |
