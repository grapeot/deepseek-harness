...
| `ctx.credentialSources` | `core` | [`credentials`](../packages/credentials/credentials) | [`credentials-oauth`](../packages/credentials/credentials-oauth) | [`credentials-local`](../packages/credentials/credentials-local) | - | Sources register resolve/describe for the references they own; the local provider folds them between the inherited environment and the managed file. |
