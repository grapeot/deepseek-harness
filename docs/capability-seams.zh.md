...
flowchart LR
  ...
  svc_credentialSources["ctx.credentialSources<br/>Dynamic credential-source registry"]
  ...
  pkg_credentials --> svc_credentialSources
  pkg_credentials --> svc_credentials
  pkg_credentials_local --> svc_credentials
  pkg_credentials_oauth --> svc_credentialSources
  ...
  svc_credentialSources --> pkg_credentials_local
...
| `ctx.credentialSources` | `core` | [`credentials`](../packages/credentials/credentials) | [`credentials-oauth`](../packages/credentials/credentials-oauth) | [`credentials-local`](../packages/credentials/credentials-local) | - | source 对其拥有的引用注册 resolve/describe；本地提供方把它们折进继承环境与托管文件之间。 |
