...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/credentials/credentials-oauth': { kind: 'indirect', reason: 'A resolved access token authorizes provider requests as a bearer; the consuming LLM adapter owns every model-visible surface.' },
