...
| 包 | 角色 | ctx 键 |
|---|---|---|
| [`credentials/`](credentials/README.md) | 凭据引用 seam | `ctx.credentials`、`ctx.credentialSources` |
| [`credentials-local/`](credentials-local/README.md) | 环境与本地文件提供方 | 注册 `ctx.credentials` |
| [`credentials-oauth/`](credentials-oauth/README.md) | OAuth token 存储与 `/oauth` | 向 `ctx.credentialSources` 注册 source |
